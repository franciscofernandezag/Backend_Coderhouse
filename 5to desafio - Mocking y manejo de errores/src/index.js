...
import { authenticate, errorHandler , verifyProducts } from './middlewares.js';
...
// Módulo de Mocking para productos
app.get("/mockingproducts", verifyProducts, (req, res) => {
  // Si todos los productos se generaron correctamente, se accede a req.mockProducts desde el middleware
  const mockProducts = req.mockProducts;
